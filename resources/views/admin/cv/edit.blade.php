...
<div class="container">
    <div class="py-3">
        ...
        <div class="bg-white p-5 rounded">
            <form action="{{ route('updateCV', $cv1->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="mb-3 d-flex">
                            ...
                            <textarea name="infor_order" id="" cols="30" rows="5" class="form-control"
                                value="{{ $cv1->infor_order }}"></textarea>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <img src="{{ asset('images/cv/' . $cv1->avatar) }}" alt="">
