                ...
                <div class="login-post d-flex justify-content-between">
                    @if (Auth::check())
                        @if (Auth::user()->role === 3 || Auth::user()->role === 1)
                            <a href="{{ route('createJob') }}" class="pr-3">
                            ...
                            <div class="position-relative">
                                <div
                                    ...
                                    <svg class="mr-1" stroke="currentColor" fill="currentColor" stroke-width="0"
                                        viewBox="0 0 24 24" class="hidden h-5 w-5 lg:block" height="1em"
                                    ...
                                    <svg class="arrow-login ml-1" stroke="currentColor" fill="currentColor"
